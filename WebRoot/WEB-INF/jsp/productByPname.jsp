...
<div class="container productList">
		...
		<div class="span18 last">
			...
			<form id="productForm" action="${pageContext.request.contextPath}/image/蔬菜 - Powered By Mango Team.htm" method="get">
				...
				<div id="result" class="result table clearfix">
						<ul>
							<s:iterator var="p" value="pageBeanSearch.list">
							<li>
	...
	<%-- <div class="pagination">
					<span>第 <s:property value="pageBeanSearch.page"/>/<s:property value="pageBeanSearch.totalPage"/> 页</span>
		<s:if test="pageBeanSearch != null">
			<s:if test="pageBeanSearch.page != 1">
				...
				<a href="${ pageContext.request.contextPath }/product_searchform.action?page=<s:property value="pageBean.page-1"/>" class="previousPage">&nbsp;</a>
			</s:if>
	...
	<div class="pagination">
		...
		<s:if test="pageBeanSearch != null">
			...
			<s:if test="pageBeanSearch.page != 1">
				<a href="${ pageContext.request.contextPath }/product_searchform.action?searchpname=<s:property value="#session.searchpname"/>&page=1" class="firstPage">&nbsp;</a>
				<a href="${ pageContext.request.contextPath }/product_searchform.action?searchpname=<s:property value="#session.searchpname"/>&page=<s:property value="pageBeanSearch.page-1"/>" class="previousPage">&nbsp;</a>
			</s:if>
			
			<s:iterator var="i" begin="1" end="pageBeanSearch.totalPage">
				<s:if test="pageBeanSearch.page != #i">
					<a href="${ pageContext.request.contextPath }/product_searchform.action?searchpname=<s:property value="#session.searchpname"/>&page=<s:property value="#i"/>"><s:property value="#i"/></a>
				</s:if>
				<s:else>
					<span class="currentPage"><s:property value="#i"/></span>
				</s:else>
			...
			<s:if test="pageBeanSearch.page != pageBeanSearch.totalPage">	
				<a class="nextPage" href="${ pageContext.request.contextPath }/product_searchform.action?searchpname=<s:property value="#session.searchpname"/>&page=<s:property value="pageBeanSearch.page+1"/>">&nbsp;</a>
				<a class="lastPage" href="${ pageContext.request.contextPath }/product_searchform.action?searchpname=<s:property value="#session.searchpname"/>&page=<s:property value="pageBeanSearch.totalPage"/>">&nbsp;</a>
			</s:if>
		</s:if>	
