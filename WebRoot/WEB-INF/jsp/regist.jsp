...
<div class="headerAd" style="background-color:red;display:none;">
	...
	<script>
		...
		<div class="span24">
			...
			<div><strong><s:actionerror/>11</strong></div>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off">
											 <img id="checkImg" class="checkImg" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
